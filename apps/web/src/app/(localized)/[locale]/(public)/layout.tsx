...
import { PublicSiteHeader } from "@/app/(localized)/[locale]/(public)/_components/site-header";
import { PublicSiteFooter } from "@/app/(localized)/[locale]/(public)/_components/site-footer";
