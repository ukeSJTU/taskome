...
| Job                | What it does                                                                                                                                                 |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `check`            | `mise run check`: lint, format check, and typecheck across the whole repo (TypeScript and Python). Read-only, no autofixes applied.                          |
| `test-unit`        | Unit tests for TS packages/apps, Gateway, and `packages/task-kit`.                                                                                           |
...
| `build`            | Compiles Web and Docs with CI-only placeholder environment variables. Does not deploy or publish anything.                                                   |
