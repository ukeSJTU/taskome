...
> ADR-0023 retains Caddy but supersedes this routing topology: Web, Docs, and Gateway now use `example.com`, `docs.example.com`, and `api.example.com`, with Gateway exposing only `/v1`, `/mcp`, and required discovery paths at the public edge.
