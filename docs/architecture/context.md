...
- [`docs/adr/0009-cli-oauth-login-and-api-key-automation.md`](../adr/0009-cli-oauth-login-and-api-key-automation.md) — the current access-channel and CLI-auth decision behind this diagram.
