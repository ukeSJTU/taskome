...
test: {
  ...
  projects: [
    ...
    { resolve: { alias: sharedAlias },
      test: { name: "jsdom", include: ["src/app/**/_components/**/*.test.tsx"], environment: "jsdom", environmentOptions: { jsdom: { url: "http://localhost:3000" } }, setupFiles: ["./src/test/setup.jsdom.ts"] } },
  ],
}
```
